...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate foundation retrieval on held-out crops")
    ...
    parser.add_argument("--no-rotation-tta", action="store_true")

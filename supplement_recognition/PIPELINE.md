...
| 지표 | 결과 |
|---|---|
| Gemini 제품명 추출 성공률 | 24/24 = 100% |
| Gemini 제품명 유사도 (추출명 vs 정답) | 91.2% |
| DB 정확 매칭률 | 19/24 = **79.2%** |

DB 미등재 5건 중 2건(비타민 활기력샷, 얼라이브 원스데일리 밀크씨슬)은 DB 자체에 없는 제품으로 코드로 해결 불가. 나머지 3건은 스코어링 개선으로 해소.
